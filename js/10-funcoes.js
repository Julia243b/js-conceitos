/* 
    ...
    Você pode definir uma função uma vez e usar(chamar/invocar) essa função quantas vezes quiser
    ...
    template literal strings (template strings) é ua forma de lidarmos com strings dinâmicos, pois podemos inserir variáveis, quebra de linhas.
...
// Pois o prompt por padrão lida com string
